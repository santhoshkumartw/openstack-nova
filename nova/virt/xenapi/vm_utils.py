...
class VMHelper(HelperBase):
    ...
    def create_vif(cls, session, vm_ref, network_ref, mac_address,
        ...
        VIF reference."""
        # Added VM name retrieval - Somik
        vm_rec = session.get_xenapi().VM.get_record(vm_ref)
        ...
        vif_rec['MTU'] = '1500'
        # Changed from empty map - Somik
        vif_rec['other_config'] = {"nicira-iface-id" : "%s-eth%d" % (vm_name, dev)}
